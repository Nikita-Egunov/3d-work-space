...
export function Model(props: JSX.IntrinsicElements['group']) {
  const { nodes, materials } = useGLTF('/3d-work-space/models//laptop/scene-transformed.glb') as unknown as GLTFResult
  return (
...
useGLTF.preload('/3d-work-space/models//laptop/scene-transformed.glb')
