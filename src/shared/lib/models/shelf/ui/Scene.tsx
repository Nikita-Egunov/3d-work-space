...
export function Model(props: JSX.IntrinsicElements['group']) {
  const { nodes, materials } = useGLTF('/public/models/white_shelf/scene-transformed.glb') as unknown as GLTFResult
  return (
...
useGLTF.preload('/public/models/white_shelf/scene-transformed.glb')
